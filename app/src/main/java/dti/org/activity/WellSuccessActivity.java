...
import dti.org.adapter.photograph.PhotographAdapter;
...
public class WellSuccessActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (wellInstall != null) {
            ...
            //刷新图片
            List<Bitmap> bitmapList = wellInstall.getCameraList().getList();
            LinearLayoutManager layoutManager1 = new LinearLayoutManager(this);
            layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
            activityWellSuccessBinding.recyclerGraph.setLayoutManager(layoutManager1);
            activityWellSuccessBinding.recyclerGraph.setAdapter(new PhotographAdapter(bitmapList));
        }
