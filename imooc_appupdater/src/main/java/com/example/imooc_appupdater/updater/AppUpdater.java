package com.example.imooc_appupdater.updater;

import android.util.Log;

import com.example.imooc_appupdater.updater.net.INetManager;
import com.example.imooc_appupdater.updater.net.OKHttpNetManager;
...
public class AppUpdater {
    ...
    自身对象实例化
     */
    private static AppUpdater mAppUpdater = new AppUpdater();
